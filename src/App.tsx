    ...
    <main id="main">
      ...
      <Section id="perception" theme="soft" className="perception" nodeId="1:49" glow="1-49-imgGlowReferenceBlue">
        ...
        <div className="perception-grid">
          <article className="perception-card"><header className="perception-card__heading"><p className="perception-card__label">소비자는 제품을 이렇게 봅니다</p></header><p className="perception-card__before">“성분을 조합해 만든 일반적인 제품”이 아니라</p><h3>“효능과 작용원리까지 연구해 설계한 <em className="text-blue keep-together">기술제품</em>”</h3></article>
          <article className="perception-card"><header className="perception-card__heading"><p className="perception-card__label">소비자는 브랜드를 이렇게 인식합니다</p></header><p className="perception-card__before">단순히 제품을 광고/판매하는 브랜드가 아니라</p><h3>“해당 분야의 효능을 집중적으로 연구하는 <em className="text-blue keep-together">전문 브랜드</em>”</h3></article>
        </div>
