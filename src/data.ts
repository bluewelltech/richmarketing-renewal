...
export const patentExamples = [
  ...
  '피부 광학 투명도 강화 및 산화성 색소침착 완화를 위한 글루타티온, 나이아신아마이드 복합 화장료 조성물',
  '체지방 축적 억제 및 에너지 소비 촉진을 위한 녹차추출물, L-카르니틴 복합 식품 조성물',
  '식후 혈당 항상성 유지 및 탄수화물 대사 활성화를 위한 여주추출물, 바나바잎추출물 복합 식품 조성물',
];
