...
- 지정한 6개 영역의 강조 문구에 대각선 빛이 지나가는 텍스트 효과 적용: 기본 6초 주기, “브랜드 특허출원 기술” 제목은 4초 주기. 모션 감소 설정에서는 효과 없이 원래 색으로 표시
- 핵심 구절을 묶고 의미 단위로 줄바꿈해 “전문 브랜드” 등 강조 문구가 중간에 끊기지 않도록 구성
- 320px 이상 모바일·태블릿·데스크톱 반응형 레이아웃
- 수정요청 2 반영: 모바일 반응 카드 2×2, 가격 카드 가로 2열, 인식 카드·진행 과정 여백 축소, 포지션 문구 및 특허명칭 예시 수정, 주요 문구 굵기·크기 조정
